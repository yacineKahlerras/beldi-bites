export default function Footer() {
  ...
  const socialMedia = [
    ...
    },
    {
      ...
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.62 5.367 11.987 11.988 11.987c6.62 0 11.987-5.367 11.987-11.987C24.014 5.367 18.637.001 12.017.001zM8.449 16.988c-1.297 0-2.448-.611-3.188-1.555l-.002-.003-.001-.002c-.741-.944-1.188-2.14-1.188-3.454 0-3.102 2.516-5.618 5.618-5.618 1.555 0 2.965.631 3.984 1.649l-1.061 1.061c-.723-.723-1.724-1.172-2.823-1.172-2.204 0-3.99 1.786-3.99 3.99s1.786 3.99 3.99 3.99c1.099 0 2.1-.449 2.823-1.172l1.061 1.061c-1.019 1.018-2.429 1.649-3.984 1.649z" />
        </svg>
      ),
    },
    {
