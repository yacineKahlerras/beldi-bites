...
export default function RecipeCard({ 
  ...
  const imageClasses = `
    ...
    ${variant === 'compact' ? 'h-48' : variant === 'featured' ? 'lg:w-1/2 h-64 lg:h-auto' : 'h-64'}
  `;
  ...
  return (
    <div className={cardClasses}>
        ...
        {!imageError ? (
          <div className="w-full h-full bg-gradient-to-br from-orange-200 to-amber-200 flex items-center justify-center">
            <div className="text-center text-gray-600">
              <svg className="mx-auto mb-2 w-16 h-16 text-orange-400" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="w-full h-full bg-gray-200 flex items-center justify-center">
            <div className="text-center text-gray-500">
              <svg className="mx-auto mb-2 w-12 h-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      {/* Card Content */}
      <div className={`p-6 ${variant === 'featured' ? 'lg:w-1/2 lg:flex lg:flex-col lg:justify-center' : ''}`}>
        {/* Title */}
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          {recipe.tags.slice(0, variant === 'compact' ? 2 : 3).map((tag, index) => (
            <span
              key={index}
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <div className="flex items-center space-x-1">
                <span className="text-sm text-gray-600">by {recipe.chef.name}</span>
